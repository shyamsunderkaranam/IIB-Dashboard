...
function MasterCtrl(t,e,r,h){var o=992;t.getWidth=function(){return window.innerWidth},t.$watch(t.getWidth,function(g){t.toggle=g>=o?angular.isDefined(e.get("toggle"))?e.get("toggle")?!0:!1:!0:!1}),t.toggleSidebar=function(){t.toggle=!t.toggle,e.put("toggle",t.toggle)},window.onresize=function(){t.$apply()}
	...
	t.openQueue = function(){
		...
		t.openQM = true;
		t.propertyValue = [
			{"qname":"Queue1","InhibitPut":false,"Description":"","Sharable":true,"OpenInputCount":1,"InhibitGet":true,"TriggerControl":false,"MaximumMessageLength":4194304,"OpenOutputCount":0,"CurrentDepth":0,"MaximumDepth":5000},
			{"qname":"Queue2","InhibitPut":false,"Description":"","Sharable":true,"OpenInputCount":1,"InhibitGet":true,"TriggerControl":false,"MaximumMessageLength":4194304,"OpenOutputCount":0,"CurrentDepth":0,"MaximumDepth":5000},
			{"qname":"Queue3","InhibitPut":false,"Description":"","Sharable":true,"OpenInputCount":0,"InhibitGet":false,"TriggerControl":false,"MaximumMessageLength":4194304,"OpenOutputCount":0,"CurrentDepth":0,"MaximumDepth":5000},
			{"qname":"Queue4","InhibitPut":false,"Description":"","Sharable":true,"OpenInputCount":1,"InhibitGet":true,"TriggerControl":false,"MaximumMessageLength":4194304,"OpenOutputCount":0,"CurrentDepth":0,"MaximumDepth":5000},
			{"qname":"Queue5","InhibitPut":false,"Description":"","Sharable":true,"OpenInputCount":1,"InhibitGet":true,"TriggerControl":false,"MaximumMessageLength":4194304,"OpenOutputCount":0,"CurrentDepth":0,"MaximumDepth":5000}
	...
	t.openChannel = function(){
		...
		/*h.get(t.hostName+":"+t.portNumber+"/FMQINST1/"+t.chnlApiURL)
		.then(function(response) {
...
angular.module("RDash").filter('probFilter', function() {
    return function(x) {
        var txt = "";
        switch(x){
			case "InhibitPut":
